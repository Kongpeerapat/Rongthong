...
class StatuscarView2 extends GetView<StatuscarController> {
  const StatuscarView2({super.key});
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text("จำนวน: ", style: AppFonts.fontpage),
                                  const Spacer(),
                                  Text("${order["qulity"]} ไร่"),
                                ],
                              ),
                              const SizedBox(height: 8),
                              Row(
